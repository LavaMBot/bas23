...
client.on('message', message => {
    if(command == "ريب"){
        message.channel.send('#46323361345490124942145>')/////////////// بتاعك لو مش عارف اذاى تجيبو كلم رانسى  IDهنا ال
    }
});
...
if (command == "تحدث") {
let rank = message.guild.member(message.author).roles.find('name', 'Lava');/////هنا اكتب اسم الرتبة 
